  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($this->languages as $lang_code => $lang_options) {
      ...
      switch ($this->settings['display']) {
        ...
        default:
          $options += [$lang_code => $this->t($lang_options['language']->getName())];
          break;

        case LANGDROPDOWN_DISPLAY_NATIVE:
          $options += [$lang_code => $lang_options['language']->getName()];
          break;
      ...
      if (\Drupal::moduleHandler()->moduleExists('languageicons') && isset($this->settings['widget'])) {
    ...
    if (\Drupal::moduleHandler()->moduleExists('languageicons') && !$this->settings['widget']) {
      $selected_option_language_icon = [
        ...
        '#title' => $this->languages[$selected_option]['language']->getName(),
      ];
