...
class Constants {
  ...
  /**
   * Type used for result codes for successfully processed transactions that
  ...
  /**
   * Type used for result codes for rejections due to 3Dsecure and Intercard
   * risk checks.
   */
  const TYPE_REJECTED_3DSECURE_INTERCARD = 'rejected.3dsecure_intercard';

  /**
   * Type used for result codes for rejections by the external bank or similar
   * payment system.
   */
  ...
  /**
   * Type used for result codes for rejections due to error in asynchronous
   * workflow.
   */
  const TYPE_REJECTED_ASYNC_ERROR = 'rejected.async_error';

  /**
   * Type used for result codes for rejections due to checks by external risk
   * systems.
   */
